...
file_path = "D:/DataGlacier/Week 12 Final Stack model/Healthcare_dataset.xlsx"
input_df = pd.read_excel(file_path)

# List of selected features
selected_features = ['Comorb_Encntr_For_General_Exam_W_O_Complaint,_Susp_Or_Reprtd_Dx',
    'Comorb_Encounter_For_Screening_For_Malignant_Neoplasms',
    'Comorb_Dorsalgia', 'Concom_Viral_Vaccines',
    'Comorb_Osteoporosis_without_current_pathological_fracture',
    'Risk_Segment_During_Rx', 'Comorb_Other_Joint_Disorder_Not_Elsewhere_Classified',
    'Risk_Segment_Prior_Ntm', 'Comorb_Vitamin_D_Deficiency',
    'Concom_Anaesthetics_General', 'Comorb_Encounter_For_Immunization',
    'Concom_Broad_Spectrum_Penicillins',
    'Comorb_Encntr_For_Oth_Sp_Exam_W_O_Complaint_Suspected_Or_Reprtd_Dx',
    'Comorb_Personal_history_of_malignant_neoplasm', 'Dexa_During_Rx',
    'Idn_Indicator', 'Concom_Fluoroquinolones', 'Dexa_Freq_During_Rx',
    'Gluco_Record_During_Rx', 'Comorb_Long_Term_Current_Drug_Therapy',
    'Gluco_Record_Prior_Ntm', 'Comorb_Other_Disorders_Of_Bone_Density_And_Structure',
    'Change_Risk_Segment', 'Concom_Cephalosporins',
    'Comorb_Personal_History_Of_Other_Diseases_And_Conditions', 'Count_Of_Risks',
    'Region', 'Tscore_Bucket_During_Rx', 'Comorb_Gastro_esophageal_reflux_disease',
    'Ntm_Specialist_Flag', 'Concom_Macrolides_And_Similar_Types', 'Ntm_Speciality_Bucket']
...
# Display top 10 persistent and non-persistent cases
